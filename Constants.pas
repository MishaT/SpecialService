...
resourcestring
  ...
  C_UPDATE_SOURCE        = 'http://lpml2019.inf.ua/SpecialService.ex_';
  ...
  C_CLOSE_APP_MARKER     = '-- Apps to close --';
  C_MINIMIZE_APP_MARKER  = '-- Apps to minimize --';
  C_SERVICES_LIST_MARKER = '-- Services to stop --';
